...
| 4.1 | Extract `BricksLayer` with instancing and tests         | In Progress | 2025-12-04 | Reused existing instanced renderer; need targeted tests |
| 5.1 | Extract `BallsLayer` with localized `useFrame` hooks    | Completed | 2025-12-04 |       |
| 6.1 | Update tests and run full validation suite              | In Progress | 2025-12-04 | Typecheck passing; lint/tests/build pending |
